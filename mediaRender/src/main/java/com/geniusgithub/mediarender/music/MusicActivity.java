...
public class MusicActivity extends BaseActivity implements MediaControlBrocastFactory.IMediaControlListener,
    ...
    private final String SPEECHCOMPLETE = "android.intent.msg.SPEECHCOMPLETE";
    private final String WAKEUP = "android.intent.msg.WAKEUP";
    private final String BACK = "android.intent.msg.BACK";
    private final String TEMPPAUSE = "android.intent.msg.TEMPPAUSE";
    private final String PAUSE = "android.intent.msg.PAUSE";
    private final String PLAY = "android.intent.msg.PLAY";
    ...
    private static final String VALUE_PLAY = "[DLNA]@@play";
    private static final String VALUE_STOP = "[DLNA]@@stop";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        filter.addAction(SPEECHCOMPLETE);
        filter.addAction(WAKEUP);
        filter.addAction(BACK);
        filter.addAction(TEMPPAUSE);
    ...
    private BroadcastReceiver receiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            Log.d("LEO",action+"===action");
            if (action.equals(SPEECHCOMPLETE)) {
                if(isArtificial){
                    pause();
                }else{
                    play();
               ...
               stop();
            } else if (action.equals(TEMPPAUSE)) {
               /* if(isArtificial){
                    pause();
                }else{
                    play();
