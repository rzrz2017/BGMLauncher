...
public class DataUtils {
    ...
    public static ArrayList<Album> makeData() {
        ...
        album.resId = R.drawable.ic_alumb_1;
        ...
        album = new Album();
        album.resId = R.drawable.ic_alumb_2;
        ...
        album = new Album();
        album.resId = R.drawable.ic_alumb_3;
        ...
        album = new Album();
        album.resId = R.drawable.ic_alumb_4;
        ...
        album = new Album();
        album.resId = R.drawable.ic_alumb_5;
        ...
        album = new Album();
        album.resId = R.drawable.ic_alumb_6;
