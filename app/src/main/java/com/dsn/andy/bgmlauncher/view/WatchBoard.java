...
import com.dsn.andy.bgmlauncher.util.SizeUtil;
...
public class WatchBoard extends View{
    ...
    private int mDialPointColor; //表盘颜色
    ...
    private void obtainStyledAttrs(AttributeSet attrs) {
        ...
        try {
            ...
            mPointRadius = (int) array.getDimension(R.styleable.WatchBoard_wb_pointer_corner_radius, DptoPx(20));
            ...
            mHourPointColor = array.getColor(R.styleable.WatchBoard_wb_hour_pointer_color, /*Color.BLUE*/Color.parseColor("#ead563"));
            mMinutePointColor = array.getColor(R.styleable.WatchBoard_wb_minute_pointer_color, Color.GRAY);
            mSecondPointColor = array.getColor(R.styleable.WatchBoard_wb_second_pointer_color, Color.WHITE);
            //  mDialPointColor=array.getColor(R.styleable.WatchBoard_wb_dail_pointer_color,Color.parseColor("#ead563"));
        } catch (Exception e) {
            //一旦出现错误全部使用默认值
            mPadding = DptoPx(10);
            mTextSize = SptoPx(16);
    ...
    public void paintCircle(Canvas canvas) {
       /* mPaint.setColor(Color.T*//*Color.parseColor("#ead563")*transparent/);*/
    ...
    private void paintPointer(Canvas canvas) {
        ...
        mPaint.setColor(Color.parseColor("#ead563")/*mHourPointColor*/); //设置指针颜色
