...
public abstract class SerialPortActivity extends BaseActivity {
	...
	protected DSNApplication mApplication;
	...
	private void DisplayError(int resourceId) {
		...
		new CommomDialog(this, R.style.dialog,msg, new CommomDialog.OnCloseListener() {
			@Override
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mApplication = (DSNApplication) getApplication();
		try {
			...
			mReadThread.start();
			Log.e("andy","COM serialport oncreate");
	...
	protected void onStart() {
		...
		if(mWakeLock == null){
			...
			//CPU ON,SCREEN OFF,KEYBORAD OFF
